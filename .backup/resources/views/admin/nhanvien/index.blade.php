 ...
 @include('partials.alert-info')
  <div class="row-fluid">
    <div class="widget-box">
        <form action="" method="post" id="dulieu_check_multi">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button type="button" class="btn btn-mini btn-danger xacnhan" data-action="#" name="del_dulieu" data-value="">Xóa</button>
                  </td>
                </tr>
                @endforeach
              </tbody>
